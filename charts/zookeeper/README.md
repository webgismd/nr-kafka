...
| `securityContext.fsGroup`            | Group ID for the container (ZooKeeper master pod)                                         | `1000879999`                         |
| `securityContext.runAsUser`          | User ID for the container (ZooKeeper master pod)                                          | `1000879999`                         |
